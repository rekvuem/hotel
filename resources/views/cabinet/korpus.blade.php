          ...
          <tr>
            ...
            <td class="" style="cursor: pointer">
              <a href="#" 
                 ...
                 data-rangedate="{{ $selectD->day }}.{{$selectD->month_year}}"
                 data-toggle="modal" 
                 data-target="#modal_theme_bg_custom"><i class="icon-pencil5"></i></a>
            </td>
            @elseif($selectD->takeVid == 'ремонт')
            <td class="{{$takeVidType}}" 
              ...
              <span class="float-right delete" 
                    data-bron="{{ $selectD->id_bron }}"
                    data-room="{{ $selectD->room_id }}"
                    data-start="{{ $selectD->bron_start_date }}"
                    data-end="{{ $selectD->bron_end_date }}"
            ...
            <td class="{{$takeVidType}}">
              ...
              <div class="text-center ">  
                <span class="delete"   
                   ...
                   data-room="{{ $selectD->room_id }}"
                   data-start="{{ $selectD->bron_start_date }}"
                   data-end="{{ $selectD->bron_end_date }}"><i class="mi-delete text-danger-300"></i></span>   
              </div>
            </td>
            @endif
          </tr>
